...
if __name__ == "__main__":
    ...
    for episode in range(total_episodes):
        ...
        # write to tensorboard mean episodic return
        writer.add_scalar("Mean Episodic Return", np.mean(total_episodic_return), episode)
        ...
        if episode % 20 == 0:
            torch.save(agent, f"models/ppo_{episode}.pt")
